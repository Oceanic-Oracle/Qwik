...
const (
	Sender_SendMail_FullMethodName = "/api.Sender/SendMail"
)
...
type SenderClient interface {
	SendMail(ctx context.Context, in *SendMailReq, opts ...grpc.CallOption) (*SendMailRes, error)
}
...
func (c *senderClient) SendMail(ctx context.Context, in *SendMailReq, opts ...grpc.CallOption) (*SendMailRes, error) {
...
func (UnimplementedSenderServer) SendMail(context.Context, *SendMailReq) (*SendMailRes, error) {
...
func _Sender_SendMail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SenderServer).SendMail(ctx, req.(*SendMailReq))
	}
